...
def multi_video_dl(self, event):
    ...
    if self.m_comboBox1.GetSelection() == 0:
        os.system(
                "yt-dlp -f best[height=2160]+bestaudio -a \""
                + link
                + "\" -o \""
                + directory
        ...
        os.system(
                "yt-dlp -f best[height=1440]+bestaudio -a \""
                + link
                + "\" -o \""
                + directory
        ...
        os.system(
                'yt-dlp -f "best*[height=1080]+bestaudio" -a \"'
                + link
                + "\" -o \""
                + directory
        ...
        os.system(
                'yt-dlp -f "best*[height=720]+bestaudio" -a \"'
                + link
                + "\" -o \""
                + directory
        ...
        os.system(
                'yt-dlp -f "best*[height=480]+bestaudio" -a \"'
                + link
                + "\" -o \""
                + directory
        ...
        os.system(
                'yt-dlp -f "best*[height=360]+bestaudio" -a \"'
                + link
                + "\" -o \""
                + directory
        ...
        os.system(
                'yt-dlp -f "best*[height=240]+bestaudio" -a \"'
                + link
                + "\" -o \""
                + directory
        ...
        os.system(
                'yt-dlp -f "best*[height=144]+bestaudio" -a \"'
                + link
                + "\" -o \""
                + directory
