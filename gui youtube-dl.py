...
class CalcFrame(yt_dl.MyFrame):
    ...
    def video_dl(self, event):
        ...
        if self.quality_selection_drop_down.GetSelection() == 0:
            ...
            os.system('youtube-dl -v -f bestvideo[width=640]+bestaudio '+ link + ' -o "' + directory + '/%(title)s-%(id)s-360p.%(ext)s" ' + args)
            #test
            ...
            directory = str(self.m_dirPicker1.GetPath())
            args = str(self.m_custom_args.GetValue())
            os.system('youtube-dl -v -f bestvideo[width=854]+bestaudio '+ link + ' -o "' + directory + '/%(title)s-%(id)s-480p.%(ext)s" ' + args)
            #test
            #print('youtube-dl -v -f 22 '+ link + ' -o "' + directory + '\%(title)s-%(id)s.%(ext)s" '  )
            ...
            directory = str(self.m_dirPicker1.GetPath())
            args = str(self.m_custom_args.GetValue())
            os.system('youtube-dl -v -f bestvideo[width=1280]+bestaudio '+ link + ' -o "' + directory + '/%(title)s-%(id)s-720p.%(ext)s" ' + args)
            #test
            #print('youtube-dl -v -f 22 '+ link + ' -o "' + directory + '\%(title)s-%(id)s.%(ext)s" '  )
            ...
            directory = str(self.m_dirPicker1.GetPath())
            args = str(self.m_custom_args.GetValue())
            os.system('youtube-dl -v -f bestvideo[width=1920]+bestaudio '+ link + ' -o "' + directory + '/%(title)s-%(id)s-1080p.%(ext)s" ' + args)
            #test
            ...
            directory = str(self.m_dirPicker1.GetPath())
            args = str(self.m_custom_args.GetValue())
            os.system('youtube-dl -v -f bestvideo[width=2560]+bestaudio '+ link + ' -o "' + directory + '/%(title)s-%(id)s-1440p.%(ext)s" ' + args)
            #test
            #print('youtube-dl -v -f 22 '+ link + ' -o "' + directory + '\%(title)s-%(id)s.%(ext)s" '  )
            ...
            directory = str(self.m_dirPicker1.GetPath())
            args = str(self.m_custom_args.GetValue())
            os.system('youtube-dl -v -f bestvideo[width=3840]+bestaudio '+ link + ' -o "' + directory + '/%(title)s-%(id)s-4k.%(ext)s" ' + args)
            #test
            #print('youtube-dl -v -f 22 '+ link + ' -o "' + directory + '\%(title)s-%(id)s.%(ext)s" '  )
